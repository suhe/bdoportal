	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-9">
				<div class="clearfix">
					{!!Form::text('first_name',isset($data)?$data->first_name:null, ['maxlength' => 100, 'class' => 'form-control col-xs-12 col-sm-6','id'=>'first_name','placeholder'=>lang::get('label.first name')]) !!}
				</div>
			</div>		
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-9">
				<div class="clearfix">
					{!!Form::text('last_name',isset($data)?$data->last_name:null, ['maxlength' => 100, 'class' => 'form-control col-xs-12 col-sm-6','id'=>'last_name','placeholder'=>lang::get('label.last name')]) !!}
				</div>
			</div>		
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-12 col-sm-9">
				<div class="clearfix">
					{!!Form::text('email',isset($data)?$data->email:null, ['maxlength' => 100, 'class' => 'form-control col-xs-12 col-sm-6','id'=>'email','placeholder'=>lang::get('label.email')]) !!}
				</div>
			</div>		
		</div>
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-2 no-padding-right" for="country">{!! Lang::get('label.role') !!} *</label>
			<div class="col-xs-11 col-sm-3">
				<div class="clearfix">
					{!! Form::select('role_id', \App\Models\Role::where('active',1)->lists('name', 'id'), isset($data)?$data->role_id:null, ['maxlength' => 100,'placeholder' => Lang::get('message.role'),'class' => 'form-control col-sm-12' ,'id' => 'role_id']) !!}
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-2 no-padding-right" for="name">{!! Lang::get('label.leave entitlement') !!} *</label>
			<div class="col-xs-12 col-sm-9">
				<div class="clearfix">
					{!!Form::text('information',isset($data)?$data->information:null, ['maxlength' => 100, 'class' => 'form-control col-xs-12 col-sm-6','id'=>'information','placeholder'=>lang::get('label.leave entitlement')]) !!}
				</div>
			</div>		
		</div>	
...
{!! JsValidate::formRequest('\App\Http\Requests\UserRequest', '#storeForm') !!}	
