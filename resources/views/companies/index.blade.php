...
<div class="row">
	<div class="col-md-12 margin-bottom-10">
		<div class="row">
			<div class="col-md-2">
				<a href="{!! url('administration/companies/form') !!}" class="btn btn-primary btn-md"><i class="fa fa-pencil"></i> {!! Lang::get('menu.add new') !!}</a>
			</div>
		</div>	
	</div>
...
<script type="text/javascript">
	$('.delete').on('click', function(event) {
		...
		$.ajax({
			type :"POST",
			url : "{!! url('administration/companies/delete') !!}",
			data : {id: id},
			cache : false,
			beforeSend: 
				function (xhr) {
